...
**TBS Lucid H7 Flight Controller - ICM42688** -- [TBS product page](https://www.team-blacksheep.com/products/prod:lucid_h7?srsltid=AfmBOoqm1P3rKUduaVLpS7PoSnZ1OvNZD1bLFvPFrDRYj9yclz82P66P), [ArduPilot hardware doc](https://ardupilot.org/copter/docs/common-tbs-lucidh7.html). Manual: [attachments/tbs-lucid-manual.pdf](https://github.com/symmatree/fables/blob/main/Drones/rekon10/attachments/tbs-lucid-manual.pdf). Gorilla pattern PDF: [attachments/tbs-gorilla-mounting-pattern.pdf](https://github.com/symmatree/fables/blob/main/Drones/rekon10/attachments/tbs-gorilla-mounting-pattern.pdf).
...
[`firmware/esc/` (coordinator)](../../firmware/esc/README.md)). With the calibrated firmware the ESC readout tracks a
...
**FC parameters:** the full Mission Planner export and the subsystem-decomposed fragments now live in coordinator [`ardupilot/`](../../ardupilot/README.md) (ground-truth `rekon10-methodi.param` + `inputs/*.param` with per-param rationale/provenance). Rationale and wiring context: [ardupilot.md](ardupilot.md).
...
Reproducible build env, patch, and hex: [`firmware/esc/` (coordinator)](../../firmware/esc/README.md). Full
...
**Motors:** **iFlight Helion 10 3110 900KV** (also sold as Xing2 3110 900KV). Datasheet PDF: [attachments/Helion-10-3110-900KV-EN.pdf](https://github.com/symmatree/fables/blob/main/Drones/rekon10/attachments/Helion-10-3110-900KV-EN.pdf).

**Props:** **Master Airscrew MR Series 10x4.5 2-blade** -- one pair **CW** and one **CCW** ([MR series](https://www.masterairscrew.com/pages/mr-drone-propellers)). Rotation reference: [attachments/Multirotor_prop_direction_3DR.pdf](https://github.com/symmatree/fables/blob/main/Drones/rekon10/attachments/Multirotor_prop_direction_3DR.pdf). Other props available, will test multiple variants.
...
**MATEKSYS ExpressLRS 2.4GHz True Diversity (ELRS R24-TD)** -- [manufacturer](https://www.mateksys.com/?portfolio=elrs-r24-td). Photos: [attachments/R24-TD_1.jpg](https://github.com/symmatree/fables/blob/main/Drones/rekon10/attachments/R24-TD_1.jpg), [attachments/R24-TD_3.jpg](https://github.com/symmatree/fables/blob/main/Drones/rekon10/attachments/R24-TD_3.jpg).
...
**WiFi / OTA:** Receiver on **ExpressLRS 3.6.3**, joined to **house WiFi** for Web UI and updates. LAN address **10.0.4.65** (DHCP reservation; hostname **rekon-rx.local.symmatree.com**). Summary: [rekon-rx](https://github.com/symmatree/fables/blob/main/kb/rekon-rx.md).
...
**Caddx / Walksnail Avatar HD Pro Kit - 32GB w/ Dual Antennas** -- [product page](https://www.caddxfpv.com/products/walksnail-avatar-hd-pro-kit-dual-antenna). Local docs: [attachments/walksnail-vtx.webp](https://github.com/symmatree/fables/blob/main/Drones/rekon10/attachments/walksnail-vtx.webp), [attachments/Avatar_V2_DUAL_kit_Quickstart_Guide.pdf](https://github.com/symmatree/fables/blob/main/Drones/rekon10/attachments/Avatar_V2_DUAL_kit_Quickstart_Guide.pdf), [attachments/Goggles_X_User_Manual_EN_V1.2.pdf](https://github.com/symmatree/fables/blob/main/Drones/rekon10/attachments/Goggles_X_User_Manual_EN_V1.2.pdf).
...
**Canonical:** coordinator [`docs/rtk-corrections-path.md`](../../docs/rtk-corrections-path.md) -- full path, rates, and the leading no-RTK-failure theory.
...
* PA0101 LGA-14 to DIP-14 SMT Adapter ([ProtoAdvantage](https://www.proto-advantage.com)) - cut in half to be a 6-pin 0.8mm to 2.54mm pitch changer
...
**iFlight XT60 Anti Spark Filter Module** -- inline XT60 [attachments/Anti%20Spark%20Filter%20Instruction_20240918.pdf](https://github.com/symmatree/fables/blob/main/Drones/rekon10/attachments/Anti%20Spark%20Filter%20Instruction_20240918.pdf). Always plug / unplug the battery side of this module.
