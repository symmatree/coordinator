...
Service name: `vio-tracker` in `stacks/coordinator/compose.yaml` (no profile -- part of the operational set; `coord start vio-tracker` runs it alone). Stack layout and bench steps: [docs/bench-tracker.md](../../docs/bench-tracker.md).
