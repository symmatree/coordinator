...
`.github/workflows/build-containers.yaml` builds natively on `ubuntu-24.04-arm` (running the isolation test) and pushes to `ghcr.io/symmatree/coordinator-mavlink` on push to `main`.
